...
public class TableauxPropI extends PApplet {
...
public boolean validInputFormula(String formula) {
...
public String changeSymbol(String input, char from, char to) {
  int i;
  int l = input.length();
  if(l > 0) {
...
public boolean branches(String s){ 
        String [] m = match(s, "(.)\\[(.)(\\[.+\\]|.)(\\[.+\\]|.)\\]");
     if (m!=null)  {
...
public boolean notbranches(String s) {
        String [] m = match(s, "(.)\\[(.).+");
...
public String res1 (String s) {int i=4; String arg1=""; int p=0;
...
public String inv(String c) {
  if(c.equals("V")) return "F";
  else return "V";
}

public String res2 (String s) {
...
public void mouseDragged() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "TableauxPropI" });
  }
}
